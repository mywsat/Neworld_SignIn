...
# action  linux服务器驱动地址
s = Service(executable_path='/home/runner/work/Neworld_SignIn/Neworld_SignIn/driver/chromedriver')
driver = webdriver.Chrome(service=s,chrome_options=chrome_options)    # Chrome浏览器  
